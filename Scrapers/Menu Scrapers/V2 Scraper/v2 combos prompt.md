WE NEED FRENCH AND ENGLISH SCRAPER
\
...
1. In the landing page (https://aggregator-admin.menu.ca/index.php/welcome/index) look for a <nav> bar. Inside the nav bar search for a <li class> element with this <a> element: <a title="Restaurants" href="#"> <i class="fa-lg fa-fw fa fa-glass"></i> <span class="menu-item-parent">Restaurants</span> <b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b></a>. The anchor element contains a <b class="collapse-sign"><em class="fa fa-plus-square-o"></em></b> element. Make sure that the collapse sign is open. You will notice it is open when the <li> element has "open" as a class and you are able to see this elements:

<ul style="display: block;">
    <li class="">
        <a href="https://aggregator-admin.menu.ca/index.php/restaurants/add">
                                                    Add restaurant
                                                </a>
    </li>
                                <li class="">
        <a href="https://aggregator-admin.menu.ca/index.php/restaurants/show/active">
                                                    Active
                                                </a>
    </li>
                                <li class="">
        <a href="https://aggregator-admin.menu.ca/index.php/restaurants/show/pending">
                                                    Pending
                                                </a>
    </li>
                                <li class="">
        <a href="https://aggregator-admin.menu.ca/index.php/restaurants/show/inactive">
                                                    Inactive
                                                </a>
    </li>
</ul>

CLick on <li class=""> <a href="https://aggregator-admin.menu.ca/index.php/restaurants/show/active">Active </a></li> to access the list of active v2 restaurants.
