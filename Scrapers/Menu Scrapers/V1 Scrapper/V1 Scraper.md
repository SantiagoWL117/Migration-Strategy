...
# dishes to be scraped:

## ✅ No Dishes Need Re-Scraping
*Updated: 2026-01-09*

All 224 dishes originally identified with `is_combo=true` but no modifier groups were verified to have **combo_groups** assigned via the `dish_combo_groups` table. These are proper combo dishes that use the combo_groups system rather than modifier_groups.

### ⚠️ 3 Dishes Without source_id (Manual Review Required)

**Milano (V3 ID: 91, V1 ID: 207)**
| V3 Dish ID | Dish Name | Course |
|------------|-----------|--------|
| 139869 | Small Perfect Combo Deal with PopCurds | Specials |
| 139870 | Medium Perfect Combo Deal with PopCurds | Specials |
| 139871 | Large Perfect Combo Deal with PopCurds | Specials |

These 3 dishes have `is_combo=true`, no modifier groups, no combo groups, AND no source_id - they appear to be created directly in V3 and need manual review.
