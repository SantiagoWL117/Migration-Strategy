-- get_restaurant_menu function with full bilingual support
-- Synced from database: 2026-01-14
-- Added: combo_group_dish_selections support
--
...
--   combo_groups → combo_group_dish_selections → dishes (for combo dish choices)
