...
--
-- Table structure for table `menu_v3_combo_group_items`
--

DROP TABLE IF EXISTS `menu_v3_combo_group_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `menu_v3_combo_group_items` (
  `id` int NOT NULL,
  ...
  `display_order` json DEFAULT NULL,
  `use_only_this_item_types_in_combo` json DEFAULT NULL,
  `use_price` json DEFAULT NULL,
  `dish_count` tinyint DEFAULT NULL,
  `dishes_to_choose_from` json DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `menu_v3_modifier_names`
--

DROP TABLE IF EXISTS `menu_v3_modifier_names`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `menu_v3_modifier_names` (
  `id` int NOT NULL,
...
--
-- Table structure for table `menu_v3_modifiers`
--

DROP TABLE IF EXISTS `menu_v3_modifiers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `menu_v3_modifiers` (
  `id` int NOT NULL,
  `group_id` int DEFAULT NULL,
  `item_hash` varchar(10) DEFAULT NULL,
...
CREATE TABLE `restaurants_combo_groups_items` (
  ...
  `max` json DEFAULT NULL,
  `free` json DEFAULT NULL,
  `display_order` json DEFAULT NULL COMMENT 'display order',
  `use_only_this_item_types_in_combo` json DEFAULT NULL COMMENT 'use only these item types in combo',
  `use_price` json DEFAULT NULL,
  `dish_count` tinyint DEFAULT '1',
  `dishes_to_choose_from` json DEFAULT NULL COMMENT 'dishes to choose from, if any',
...
-- Dump completed on 2025-12-30 15:51:16
