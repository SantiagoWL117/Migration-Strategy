# Convert menuca_v1_delivery_info.sql to CSV
# Source: Database/Delivery Operations/dumps/menuca_v1_delivery_info.sql
# Target: Database/Delivery Operations/CSV/menuca_v1_delivery_info.csv

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$dumpFile = Join-Path $scriptDir "dumps\menuca_v1_delivery_info.sql"
$csvFile = Join-Path $scriptDir "CSV\menuca_v1_delivery_info.csv"

Write-Host "Converting menuca_v1_delivery_info.sql to CSV..." -ForegroundColor Cyan

# Read the SQL dump
$content = Get-Content $dumpFile -Raw

# Extract INSERT statements
$pattern = "INSERT INTO \`delivery_info\` VALUES \((.*?)\);"
