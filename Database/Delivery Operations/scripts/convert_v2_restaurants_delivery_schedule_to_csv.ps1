# Convert menuca_v2_restaurants_delivery_schedule.sql to CSV
# Source: Database/Delivery Operations/dumps/menuca_v2_restaurants_delivery_schedule.sql
# Target: Database/Delivery Operations/CSV/menuca_v2_restaurants_delivery_schedule.csv

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$dumpFile = Join-Path $scriptDir "dumps\menuca_v2_restaurants_delivery_schedule.sql"
$csvFile = Join-Path $scriptDir "CSV\menuca_v2_restaurants_delivery_schedule.csv"

Write-Host "Converting menuca_v2_restaurants_delivery_schedule.sql to CSV..." -ForegroundColor Cyan

# Read the SQL dump
$content = Get-Content $dumpFile -Raw

# Extract INSERT statements
$pattern = "INSERT INTO \`restaurants_delivery_schedule\` VALUES \((.*?)\);"
