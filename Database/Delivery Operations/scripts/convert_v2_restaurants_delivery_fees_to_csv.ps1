# Convert menuca_v2_restaurants_delivery_fees.sql to CSV
# Source: Database/Delivery Operations/dumps/menuca_v2_restaurants_delivery_fees.sql
# Target: Database/Delivery Operations/CSV/menuca_v2_restaurants_delivery_fees.csv

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$dumpFile = Join-Path $scriptDir "dumps\menuca_v2_restaurants_delivery_fees.sql"
$csvFile = Join-Path $scriptDir "CSV\menuca_v2_restaurants_delivery_fees.csv"

Write-Host "Converting menuca_v2_restaurants_delivery_fees.sql to CSV..." -ForegroundColor Cyan

# Read the SQL dump
$content = Get-Content $dumpFile -Raw

# Extract INSERT statements
$pattern = "INSERT INTO \`restaurants_delivery_fees\` VALUES \((.*?)\);"
