...
print("\n" + "="*80)
print("STEP 5: VALIDATE V1 SQL")
print("="*80)

# Read the generated SQL
print("\n[1/2] Reading generated SQL file...")
...
with open('extracted_data/V1_SQL_VALIDATION_REPORT.md', 'w', encoding='utf-8') as f:
    f.write("# V1 SQL Validation Report\n\n")
    f.write(f"**Generated:** {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n\n")
    f.write("---\n\n")
    f.write("## Validation Summary\n\n")
    
    all_checks_passed = (
        validation_results['total_inserts'] == 3 and  # Expected 3 V1 polygons
    ...
    f.write("|-------|--------|-------|\n")
    f.write(f"| Expected 3 inserts | {'PASS' if validation_results['total_inserts'] == 3 else 'FAIL'} | {validation_results['total_inserts']}/3 |\n")
    ...
    f.write("## Next Steps\n\n")
    if all_checks_passed:
        f.write("1. Proceed to merge V2 and V1 SQL (Step 6)\n")
        f.write("2. All V1 SQL validation checks passed\n")
    else:
...
print(f"   Validation report saved: extracted_data/V1_SQL_VALIDATION_REPORT.md")

if all_checks_passed:
    print("\n" + "="*80)
    print("[PASS] ALL VALIDATION CHECKS PASSED")
    print("="*80)
    print("\n[COMPLETE] STEP 5 COMPLETE - Proceeding to Step 6\n")
else:
    print("\n" + "="*80)
