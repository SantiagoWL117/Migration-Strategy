...
# Load the JSON files
with open('mvp_blob_deliveryArea.json', 'r', encoding='utf-8') as f:
    delivery_area_data = json.load(f)

with open('mvp_blob_delivery_schedule.json', 'r', encoding='utf-8') as f:
    delivery_schedule_data = json.load(f)

with open('mvp_blob_fee.json', 'r', encoding='utf-8') as f:
