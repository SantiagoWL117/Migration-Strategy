#!/usr/bin/env python3
"""
Extract ALL 164 active restaurant data using proper MySQL dump parsing
...
# Load ALL active V1 restaurants from mapping file
mapping = {}
...
# All V1 IDs to extract
target_v1_ids = list(mapping.keys())
print(f"Loaded {len(target_v1_ids)} target restaurants")
...
print(f"\nFound {len(results)} out of {len(target_v1_ids)} target restaurants")
print(f"{'='*60}\n")
